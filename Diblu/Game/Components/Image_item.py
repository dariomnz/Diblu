...
class Image_item():
    ...
    def image_update(self,camera):
        ...
        self.image=pygame.transform.scale(self.original_image, (int(self.original_image_size[0]*camera.zoom*S_c.getInstance().w_factor_image), int(self.original_image_size[1]*camera.zoom*S_c.getInstance().h_factor_image)))
